...
Makefile.venv:
	curl \
		-o Makefile.fetched \
		-L "https://github.com/sio/Makefile.venv/raw/v2020.05.05/Makefile.venv"
	echo "947f582cfaf84929808dc6427cee6c5a374ce958477adef413fecb5b8535f0aa *Makefile.fetched" \
		| sha256sum --check - \
